...
class Config:
    ...
    COMPETITION_ID: str = os.getenv("COMPETITION_ID", "0a5c57ad-0d11-4217-88a1-170445d72b52")
    ...
    TOKENS: Dict[str, TokenConfig] = {
        ...
        "GAIA": TokenConfig("0xd715cc968c288740028be20685263f43ed1e4837", "bsc", False, 18),
...
class MarketDataProvider:
    ...
    TOKEN_PAIRS = {
        ...
        "GAIA" : "0xd715cc968c288740028be20685263f43ed1e4837", # GAIA/USDT
    ...
    async def _fetch_all_tokens(self) -> Dict[str, Dict]:
        ...
        for symbol, address in self.TOKEN_PAIRS.items():
            ...
            chain_id = {
                ...
                "base": "base", "optimism": "optimism", "svm": "solana", "bsc": "bsc"
            }.get(chain, "ethereum")
